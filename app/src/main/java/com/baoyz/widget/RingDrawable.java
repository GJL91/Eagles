...
class RingDrawable extends RefreshDrawable{
    ...
    RingDrawable(PullRefreshLayout layout) {
        super(layout);
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        int mWidth = getRefreshLayout().getFinalOffset();
        mBounds = new RectF(bounds.width() / 2 - mWidth / 2, bounds.top, bounds.width() / 2 + mWidth / 2, bounds.top + mWidth); // Final mWidth was mHeight = mWidth;
