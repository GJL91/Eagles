...
class MaterialDrawable extends RefreshDrawable implements Animatable {
    ...
    private void createCircleDrawable() {
        ...
        int mShadowRadius = (int) (density * SHADOW_RADIUS);
...
//        ViewCompat.setLayerType(this, ViewCompat.LAYER_TYPE_SOFTWARE, circle.getPaint());
    ...
    private void setSizeParameters(double progressCircleWidth, double progressCircleHeight,
        ...
        double mWidth = progressCircleWidth * screenDensity;
        double mHeight = progressCircleHeight * screenDensity;
