...
import com.garethlewis.eagles.fetchers.TeamStatsFetcher;
...
public class TeamFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        StatsNameListAdapter passingNameAdapter = new StatsNameListAdapter(getActivity(), passingNamesList, new ArrayList<String>());
        ...
        AllStatsListAdapter passingStatsAdapter = new AllStatsListAdapter(getActivity(), passingStatsList, new ArrayList<List<String>>());
        ...
        StatsNameListAdapter rushingNameAdapter = new StatsNameListAdapter(getActivity(), rushingNameList, new ArrayList<String>());
        ...
        AllStatsListAdapter rushingStatsAdapter = new AllStatsListAdapter(getActivity(), rushingStatsList, new ArrayList<List<String>>());
        ...
        StatsNameListAdapter receivingNameAdapter = new StatsNameListAdapter(getActivity(), receivingNameList, new ArrayList<String>());
        ...
        AllStatsListAdapter receivingStatsAdapter = new AllStatsListAdapter(getActivity(), receivingStatsList, new ArrayList<List<String>>());
        ...
        StatsNameListAdapter defendingNameAdapter = new StatsNameListAdapter(getActivity(), defendingNameList, new ArrayList<String>());
        ...
        AllStatsListAdapter defendingStatsAdapter = new AllStatsListAdapter(getActivity(), defendingStatsList, new ArrayList<List<String>>());
        ...
        StatsNameListAdapter kickReturningNameAdapter = new StatsNameListAdapter(getActivity(), kickReturningNameList, new ArrayList<String>());
        ...
        AllStatsListAdapter kickReturningStatsAdapter = new AllStatsListAdapter(getActivity(), kickReturningStatsList, new ArrayList<List<String>>());
        ...
        StatsNameListAdapter puntReturningNameAdapter = new StatsNameListAdapter(getActivity(), puntReturningNameList, new ArrayList<String>());
        ...
        AllStatsListAdapter puntReturningStatsAdapter = new AllStatsListAdapter(getActivity(), puntReturningStatsList, new ArrayList<List<String>>());
        ...
        StatsNameListAdapter kickingNameAdapter = new StatsNameListAdapter(getActivity(), kickingNameList, new ArrayList<String>());
        ...
        AllStatsListAdapter kickingStatsAdapter = new AllStatsListAdapter(getActivity(), kickingStatsList, new ArrayList<List<String>>());
        ...
        StatsNameListAdapter puntingNameAdapter = new StatsNameListAdapter(getActivity(), puntingNameList, new ArrayList<String>());
        ...
        AllStatsListAdapter puntingStatsAdapter = new AllStatsListAdapter(getActivity(), puntingStatsList, new ArrayList<List<String>>());

        puntingStatsList.setAdapter(puntingStatsAdapter);

        fetcherPackage = new FetcherPackage(getActivity(), false, null);
    ...
    public void doFetch() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            new TeamStatsFetcher().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, fetcherPackage);
        } else {
            new TeamStatsFetcher().execute(fetcherPackage);
        }
    }
